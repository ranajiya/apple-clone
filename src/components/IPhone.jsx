...
const Model = ({size, item, props}) => {
  const { nodes, materials } = useGLTF(item.modelPath)
  ...
  return (
    <group {...props} scale={size === 'small' ? [15, 15, 15] : [17, 17, 17]} dispose={null}>
      <mesh
        castShadow
        receiveShadow
